...
casper.then(function() {	
this.test.comment('create a mock summary presee  biostats button');
	
	this.mouseEvent('click', '#perbioid');	
...
casper.then(function() {
	this.test.comment('press the bio stats button test title changes to off');
//html body div.container div.demo ul#sortable1.droptrue li#3865253--554494698.ui-state-default div.peranalysis a#peranalysisid.peranalysisid3865253--554494698
	...
	this.summarystatus = this.getElementAttribute('#perbioid', 'data-statusanalysis');
...
casper.then(function() {
	this.test.comment('the bio stat section exist');
//html body div.container div.demo ul#sortable1.droptrue li#3865253--554494698.ui-state-default div#historicalsummary3865253--554494698
	casper.test.assertExists('.historicalbio', 'the element exists');
